...
namespace DoozyEngine.Entity
{
    public class AnimatedSprite : Sprite
    {
        ...
        //    this.hitBox.Height = currentAnim.AnimationFrame[0][2];
        //    this.hitBox.Width = currentAnim.AnimationFrame[0][3];
        //}
        ...
        //        SourceRectangle = new Rectangle(currentAnim.AnimationFrame[animationFrame][0],currentAnim.AnimationFrame[animationFrame][1],currentAnim.AnimationFrame[animationFrame][2],currentAnim.AnimationFrame[animationFrame][3]);
